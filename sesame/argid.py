...
model_file_name = os.path.join(model_dir, f"best-argid-{VERSION}-model")
...
if options.mode in ["train", "refresh"]:
    ...
    out_conll_file = os.path.join(model_dir, f"predicted-args{suffix}.conll")
    print(out_conll_file)
else:
